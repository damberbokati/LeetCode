...
public class MainWin extends JFrame {
    ...
    protected MixIn onCreateMixIn(String prompt) {
        ...
        try {
            ...
            amounts.setSelectedItem(MixInAmount.Normal);
    ...
    protected void onAboutClick() {
        ...
        JLabel artists = new JLabel("<html>"
                + "<br/><p>Version 2.0</p>"
                + "<p>Copyright 2022 by Damber Bokati</p>"
                + "<p>Licensed under Gnu GPL 2.0</p>"
    ...
    private void view(Screen screen) {
        ...
        display.setText(
                "<html><font size=+4>" + title + "<br/></font><font size=+2>" + s.toString() + "</font></html>");
    }
    ...
    private void setOrderAvailable() {
        ...
        createOrder.setEnabled(orderIsAvailable);
